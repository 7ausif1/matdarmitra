...
**Matdar Mitra** (The Voter's Friend) is a premium, AI-powered civic engagement platform designed to simplify the Indian electoral process. Built for the **Prompt Wars Virtual** challenge, it empowers citizens with knowledge, confidence, and real-time assistance.

## 🚀 Live Demo
[View Live Site](https://matdarmitra-745097160889.europe-west1.run.app/)
...
- **Places Autocomplete**: Search for any area in India.
- **Real-time Geolocation**: Find booths within walking distance of your current position.
...
### 5. 🧠 Interactive Voter Quiz
Test your knowledge of the democratic process with instant feedback and social sharing capabilities.
...
3. To enable AI features, add your Gemini API Key in the **Assistant Settings (⚙️)** inside the app.

---
*Created with ❤️ for Democracy and the Google Prompt Wars Virtual Challenge.*
